...
```html
<link rel="stylesheet" as="style" crossorigin href="https://cdnjs.cloudflare.com/ajax/libs/pretendard-std/1.3.7/static/pretendard-std.css" />
```
...
```css
@import url("https://cdnjs.cloudflare.com/ajax/libs/pretendard-std/1.3.7/static/pretendard-std.css");
```
...
```html
<link rel="stylesheet" as="style" crossorigin href="https://cdnjs.cloudflare.com/ajax/libs/pretendard-std/1.3.7/static/pretendard-std-dynamic-subset.css" />
```
...
```css
@import url("https://cdnjs.cloudflare.com/ajax/libs/pretendard-std/1.3.7/static/pretendard-std-dynamic-subset.css");
```
...
```html
<link rel="stylesheet" as="style" crossorigin href="https://cdnjs.cloudflare.com/ajax/libs/pretendard-std/1.3.7/variable/pretendardvariable-std-dynamic-subset.css" />
```
...
```css
@import url("https://cdnjs.cloudflare.com/ajax/libs/pretendard-std/1.3.7/variable/pretendardvariable-std-dynamic-subset.css");
```
...
```html
<link rel="stylesheet" as="style" crossorigin href="https://cdnjs.cloudflare.com/ajax/libs/pretendard-std/1.3.7/variable/pretendardvariable-std.css" />
```
...
```css
@import url("https://cdnjs.cloudflare.com/ajax/libs/pretendard-std/1.3.7/variable/pretendardvariable-std.css");
```
